...
getTaskList = function () {
    try {
        if (ss.storage.redmineConfig && ss.storage.redmineConfig.redmineHost != '' && ss.storage.redmineConfig.redmineKey != '') {
            var quijote = Request({
                url: "http://" + ss.storage.redmineConfig.redmineHost + "/projects/bm/issues.json?key=" + ss.storage.redmineConfig.redmineKey + "&utf8=%E2%9C%93&set_filter=1&f[]=status_id&op[status_id]=%3D&v[status_id][]=15&v[status_id][]=1&v[status_id][]=2&v[status_id][]=4&f[]=assigned_to_id&op[assigned_to_id]=%3D&v[assigned_to_id][]=40&f[]=&c[]=project&c[]=tracker&c[]=status&c[]=priority&c[]=subject&group_by=",
